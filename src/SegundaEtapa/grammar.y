...
prog    : ID BEGIN statement_list END
        ...
        | ID error statement_list END {System.out.println("Error: Falta delimitador del programa3, linea "+AnalizadorLexico.line_number); }
        | ID BEGIN statement_list error {System.out.println("Error: Falta delimitador del programa2, linea "+AnalizadorLexico.line_number); }
        | ID statement_list {System.out.println("Error: Falta delimitador del programa1, linea "+AnalizadorLexico.line_number); }
        | /* vacio */ {System.out.println("Error: programa vacio... "); }
        ;
...
statement_list 
        ...
        | statement_list error {System.out.println("Error: sintaxis incorrecta de sentencia en linea "+AnalizadorLexico.line_number);}
        ;
...
statement
        ...
        /*| error {System.out.println("Error: sintaxis incorrecta de sentencia en linea "+AnalizadorLexico.line_number);}*/
...
if_statement
        ...
        | IF '(' cond ')' THEN ctrl_block_statement ELSE error END_IF {System.out.println("Error: Se esperaba sentencia ejecutable luego del else, linea "+AnalizadorLexico.line_number); }
...
fun_invoc
        : ID '(' expr ')'
        | ID '(' expr error ')' {System.out.println("Error: sintaxis incorrecta de invocacion a funcion. Asegurate de no pasar más de 1 parametro a una funcion, linea "+AnalizadorLexico.line_number); }
        ;
